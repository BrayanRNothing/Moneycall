      ...
      <div className="min-h-screen w-full flex flex-col p-2.5 gap-2.5 overflow-x-hidden relative font-sans">
        ...
        <div className="h-[82vh] flex flex-col lg:flex-row gap-2.5 shrink-0">
          ...
          <div className="flex-1 flex flex-col justify-between text-left p-8 md:p-12 bg-white border border-white/30 rounded-3xl premium-reflejo overflow-hidden relative min-h-[600px]">
            ...
            {/* Bottom Section: Spanning Grid */}
            <div className="relative z-20 w-full grid grid-cols-2 lg:grid-cols-4 gap-6 mt-auto pt-10 border-t border-slate-100">
              {[
                { val: "+3x", label: "Conversión de Ventas" },
                { val: "+150%", label: "Productividad" },
                { val: "10k+", label: "Prospectos Gestionados" },
                  ...
                  <div className="space-y-4">
                    <div className="group">
                      ...
                      <div className="relative flex items-center rounded-2xl overflow-hidden bg-slate-50/50 group-hover:bg-slate-50 transition-colors" style={inputWrapStyle('user')}>
                        ...
                        <input type="text" value={username} onChange={e => setUsername(e.target.value)} onFocus={() => setFocusedField('user')} onBlur={() => setFocusedField(null)} required className="w-full bg-transparent pl-14 pr-4 py-4 text-base font-bold outline-none text-slate-800 placeholder-slate-300" placeholder="Usuario" />
                      </div>
                    </div>
