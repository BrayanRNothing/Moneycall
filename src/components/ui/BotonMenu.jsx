...
const BotonMenu = ({ gradient, icon, titulo, count, badgeText, onClick }) => (
    <button onClick={onClick} className={`bg-linear-to-br ${gradient} backdrop-blur-md p-4 lg:p-6 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col items-center justify-center w-full h-full transform hover:scale-[1.01] text-white relative overflow-hidden group border border-white/10 min-h-[200px]`}>
